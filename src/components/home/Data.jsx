...
const Data = () => {
  return (
    <div className='home__data'>
        <h1 className="home__title">Yakup Zengin
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <h3 className="home__subtitle">Web Developer Student </h3>
        <p className="home__description">
          I'm a student with a strong interest in software development currently based in Bursa / Muğla. 
          <p> My dedication and passion drive me to explore and excel in the world of coding.</p>
        </p>
        
        <a href="#contact" className="button button__flex"> Contact <svg
                  class="button__icon"
                  xmlns="http://www.w3.org/2000/svg"
                  width="22"
                  height="22"
